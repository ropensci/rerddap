...
```{r VIIRSTS, fig.width = 6, fig.height = 3, fig.align = 'center', warning = FALSE, cache = TRUE}
require("ggplot2")
require("rerddap")
...
```{r VHNCHla, fig.width = 6, fig.height = 3, fig.align = 'center', warning = FALSE, cache=TRUE}
require("ggplot2")
require("mapdata")
require("rerddap")
