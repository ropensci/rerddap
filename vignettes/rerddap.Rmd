...
#>  2 Channel Islands, Kelp Forest Monitoring, Size and … erdCinpKfmSFNH           
#>  3 File Names from the AWS S3 fast-ai-imageclas Bucke… awsS3Files_fast_ai_image…
#>  4 File Names from the AWS S3 mf-nwp-models Bucket: A… awsS3Files_mf_nwp_models 
#>  5 File Names from the AWS S3 nasanex Bucket with pre… awsS3Files_nasanex_LOCA  
#>  6 File Names from the AWS S3 nasanex Bucket with pre… awsS3Files_nasanex_MODIS 
#>  7 File Names from the AWS S3 noaa-ghe-pds Bucket: NO… awsS3Files_noaa_ghe_pds  
#>  8 File Names from the AWS S3 sentinel1-slc-seasia-pd… awsS3Files_sentinel1_slc…
#>  9 File Names from the AWS S3 noaa-nexrad-level2 Buck… awsS3Files_noaa_nexrad_l…
#> 10 File Names from the AWS S3 mwapublic Bucket: Epoch… awsS3Files_mwapublic     
#> # … with 97 more rows
```
...
#>  6 Archived Suite of NOAA Coral Reef Watch Operational Tw… noaa_nodc_da4e_3fc9_…
#>  7 SST and SST Anomaly, NOAA Global Coral Bleaching Monit… NOAA_DHW_monthly     
#>  8 NOAA Coral Reef Watch Operational Daily Near-Real-Time… dhw_5km              
#>  9 USGS COAWST Forecast, US East Coast and Gulf of Mexico… whoi_geoport_ed12_89…
#> 10 USGS COAWST Forecast, US East Coast and Gulf of Mexico… whoi_geoport_61c3_0b…
#> 11 USGS COAWST Forecast, US East Coast and Gulf of Mexico… whoi_geoport_62d0_9d…
#> 12 USGS COAWST Forecast, US East Coast and Gulf of Mexico… whoi_geoport_7dd7_db…
#> 13 USGS COAWST Forecast, US East Coast and Gulf of Mexico… whoi_geoport_a4fb_2c…
```
...
#>  Dimensions (range):  
#>      time: (2006-01-01T12:00:00Z, 2020-07-14T12:00:00Z) 
#>      altitude: (0.0, 0.0) 
#>      latitude: (-45.0, 65.0) 
...
#>    Last updated: [2020-07-15 16:11:54]
#>    File size:    [0.03 mb]
...
#>    Last updated: [2020-07-15 16:12:03]
#>    File size:    [0.05 mb]
#> # A tibble: 1,304 x 4
